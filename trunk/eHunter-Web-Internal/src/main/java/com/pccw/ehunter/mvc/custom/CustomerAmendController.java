...
public class CustomerAmendController extends BaseController{
	...
	public ModelAndView updateCustomerInfo(HttpServletRequest request , @ModelAttribute(SessionAttributeConstant.CUSTOMER_DTO)CustomerDTO customerDto){
		ModelAndView mv = new ModelAndView(new RedirectViewExt("customer/viewCustomerDetail.do", true));
		
		System.out.println(">>>> GP_ID : " + customerDto.getCustGroup().getSystemGroupRefNum());
