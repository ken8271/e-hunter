...
public class UploadedCurriculumVitaeValidator extends AbstractValidator{
	...
	public void validate(Object target, Errors errors) {
		...
		if(!FileUtils.WORD_FILE_EXT.equals(dto.getType()) && !FileUtils.PDF_FILE_EXT.equals(dto.getType()) && !FileUtils.HTML_FILE_EXT.equals(dto.getType()) && !FileUtils.HTM_FILE_EXT.equals(dto.getType())){
