...
<%@attribute name="dateHH"  type="java.lang.String" required ="true"%>
<%@attribute name="dateMM"  type="java.lang.String" required ="true"%>
...
<form:input cssClass="standardInputTextNoWidth" path="${dateHH}" maxlength="2" cssStyle="height:20px;width:35px;" size="2" readonly="false" onkeyup="tabForInputText(this,'${dateMM}',2,event)" onblur="addZero(this,2);"/>:
<form:input cssClass="standardInputTextNoWidth" path="${dateMM}" maxlength="2" cssStyle="height:20px;width:35px;" size="2"   readonly="false" onblur="addZero(this,2);"/>
