	...
	<table class="standardTableForm" border="1" cellspacing="0" cellpadding="0" width="100%">
		<tbody>
			...
			<tr>
				...
				<td><form:input path="enquireDto.systemCustRefNum" cssClass="standardInputText"></form:input>
				</td>
				<td colspan="2">&nbsp;</td>
			</tr>
		</tbody>
	...
	<table class="standardTableForm" border="1" cellspacing="0" cellpadding="0" width="100%">
		<tbody>
			...
			<tr>
				...
				<td><form:input path="enquireDto.groupName" cssClass="standardInputText"></form:input>
				</td>
				<td class="labelColumn">客户名称/简称：</td>
				<td><form:input path="enquireDto.name" cssClass="standardInputText" /></td>
			</tr>
			<tr>
				<td class="labelColumn">公司性质：</td>
				<td>
				   <form:select path="enquireDto.type" cssClass="standardSelect">
				...
				<td>
				   <form:select path="enquireDto.size" cssClass="standardSelect">
						<form:option value="" label="--- 请选择 ---"></form:option>
			...
			<tr>
				...
				<td><form:select path="enquireDto.grade" cssClass="standardSelect">
						<form:option value="" label="--- 请选择 ---"></form:option>
				...
				<td><form:select path="enquireDto.status" cssClass="standardSelect">
						<form:option value="" label="--- 请选择 ---"></form:option>
		...
		<tr>
			<td class="functionMenuBar">
				<table align="right" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td><input class="standardButton" type="button" value="确定"
							onclick="submit();document.getElementById('light').style.display = 'none'; document.getElementById('fade').style.display = 'none';showAllObject();" />&nbsp;
							<input class="standardButton" type="button" value="取消"
							onclick="document.getElementById('light').style.display = 'none';document.getElementById('fade').style.display = 'none';showAllObject();">
						</td>
					</tr>
				</table>
			</td>
