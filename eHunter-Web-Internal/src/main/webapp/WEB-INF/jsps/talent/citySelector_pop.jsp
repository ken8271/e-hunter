...
<div id="city_fade" class="black_overlay"></div>
<div id="city_light" class="white_content_without_padding">
	<table cellspacing="0" cellpadding="0" width="100%" >
		<tbody>
			...
			<tr class="popUpTitle">
			   ...
			   <td align="right"><span style="cursor: pointer;font:bold 14px Arial" onclick="getSelectedCities();document.getElementById('city_light').style.display = 'none';document.getElementById('city_fade').style.display = 'none';showAllObject();">[确定]</span></td>
			   <td align="center"><span style="cursor: pointer;font: bold 14px Arial" onclick="document.getElementById('city_light').style.display = 'none';document.getElementById('city_fade').style.display = 'none';showAllObject();">[取消]</span></td>
			</tr>
			<tr height="5px">
			   <td colspan="10">
			      <select style="display: none" id="citySelector">
			         <c:forEach items="${intentionDto.expectCityDtos }" var="cityDto">
