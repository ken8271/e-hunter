...
<form:form commandName="systemParameterDto" action="${ctx}/system/updateSystemParameter.do" method="post">
	<table border="0" width="100%">
		<tr>
			<td class="pageTitle">系统参数表管理&nbsp;-&nbsp;参数编辑</td>
		</tr>
		<tr>
	...
	<table class="standardTableForm" border="1" cellspacing="0" cellpadding="0" width="100%">
		<tbody>
			...
			<tr>
				...
				<td colspan="3"><c:out value="${systemParameterDto.parameterKey }" escapeXml="true"></c:out></td>
			</tr>
			<tr>
