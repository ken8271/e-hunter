...
import cn.org.polaris.helper.ErrorMessageHelper;
...
@Controller
public class InfoCenterManagementController {
	...
	public @ResponseBody JsonResponseDTO release(@RequestBody InformationDTO dto){
		try {			
			...
			if(errors.hasErrors()){
				return new JsonResponseDTO(false , errorMessageHelper.convert2Strings(errors));
			}
			...
			return new JsonResponseDTO(false , errorMessageHelper.convert2Strings(e));
		}
	}
