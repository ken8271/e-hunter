...
CREATE TABLE T_TLNT_BS_INF (
  ...
  HM_TEL_NBR varchar(50) COMMENT '家庭电话',
  CO_TEL_NBR varchar(50) COMMENT '公司电话',
  PRI_TEL_NBR1 varchar(50) UNIQUE COMMENT '手机1',
  PRI_TEL_NBR2 varchar(50) UNIQUE COMMENT '手机2',
  PRI_TEL_NBR3 varchar(50) UNIQUE COMMENT '手机3',
